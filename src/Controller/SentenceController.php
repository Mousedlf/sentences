...
class SentenceController extends AbstractController
{
    ...
    #[Route('/admin/new', name: 'app_sentence_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/{id}/edit', name: 'app_sentence_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/{id}', name: 'app_sentence_delete', methods: ['POST'])]
